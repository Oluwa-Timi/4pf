...
export default function Wallet () {
    return (
        ...
        <div className="bg-[#0F222A] h-fit text-center p-5">
            <h1 className="text-5xl font-serif font-bold text-[#FAFAFA] p-8">CONNECT WALLET</h1>
            <p className="text-[#FAFAFA] opacity-80 text-lg font-medium">Please Select your wallet to continue</p>
        
                <div className="h-fit w-[75%] mx-auto bg-red-400 text-center grid lg:grid-cols-5 gap-2 p-5 m-5 md:grid md:grid-cols-3 md:gap-2 sm:grid sm:grid-cols-2 sm:gap-2 sm:h-fit">
            ...
            <h1 className="text-white font-semibold mt-3">TonKeeper Wallet</h1>
            </div>
            </Link>
